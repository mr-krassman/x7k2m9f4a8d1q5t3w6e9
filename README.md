...
| ----------------------------- | ------------------------------ | ------------------------------ | ---------------------------- | ---------------------------- | ---------- | ------------------ | ---------------- |
| Total Return                  | +66.0%                         | +109.0%                        | +79.7%                       | **+117.5%**                  | +93.8%     | −32.2%             | +28.3%           |
| CAGR (compounded)             | +26.5%                         | +40.8%                         | +31.3%                       | **+43.4%**                   | +36.0%     | −16.5%             | +12.3%           |
| Sharpe (0% rf)                | 0.65                           | 1.06                           | 0.83                         | **1.22**                     | **1.22**   | −0.21              | 0.28             |
| Sharpe / √exposure            | 0.99                           | 1.63                           | 1.27                         | **1.87**                     | 1.22       | −0.21              | 0.28             |
| Max Drawdown                  | −37.7%                         | −32.7%                         | −31.8%                       | **−27.4%**                   | −31.8%     | −70.3%             | −37.4%           |
| Recovery from max DD          | 140 дн.                        | 33 дн.                         | 140 дн.                      | **27 дн.**                   | 109 дн.    | не восстановился   | не восстановился |
| Longest underwater            | 365 дн.                        | 307 дн.                        | 363 дн.                      | 307 дн.                      | 246 дн.    | 535 дн.            | **233 дн.**      |
| % time in drawdown            | 92.2%                          | 88.2%                          | 90.7%                        | **86.7%**                    | 88.9%      | 98.1%              | 94.3%            |
| Calmar                        | 0.81                           | 1.55                           | 1.16                         | **1.99**                     | 1.37       | −0.21              | 0.35             |
| Profit Factor                 | 1.16                           | 1.27                           | 1.21                         | **1.32**                     | 1.27       | 0.97               | 1.04             |
| Win Rate (trades)             | 55.4%                          | **58.3%**                      | 55.4%                        | 56.8%                        | 54.8%      | 51.0%              | 50.2%            |
| Median trade return           | +0.398%                        | **+0.526%**                    | +0.299%                      | +0.393%                      | +0.043%    | +0.078%            | +0.007%          |
| Information Ratio (vs B&H 49) | 0.60 (taker)                   | 0.86 (maker)                   | 0.67 (taker)                 | **0.90 (maker)**             | 0.79       | —                  | —                |
| Worst day (net)               | −22.5% (2025-10-10, Пт)        | −22.3% (2025-10-10, Пт)        | −22.1% (2025-10-10, Пт)      | −21.9% (2025-10-10, Пт)      | −20.7% (2025-10-10, Пт) | −22.3% | **−14.0%**       |

![ML-сценарий — equity curve](research_outputs/day_of_week/backtest/plots/equity_curve_ml_49pairs_20240401_20260531.png)
**Рис. 2. ML-сценарий (day_of_week_ml)** — 49 пар, val (2024-04-01 — 2026-05-31). Красная линия — net maker, синяя — net taker; серые — B&H 49 и BTC.
...
| -------------- | --------- | --------- | ------ | ------ | -------------------- |
| **Чт** (short) | +59.4%    | +0.530%   | 0.99   | −16.5% | −0.08                |
| **Пт** (long)  | +29.5%    | +0.263%   | 0.44   | −27.8% | **−1.09**            |
| **Сб** (long)  | +28.7%    | +0.256%   | 0.82   | −11.4% | −0.03                |
...
- **Пятница** — слабое звено по риску (низкий Sharpe, глубокая просадка, skew −1.09).
...
- **Пятница** — наименее устойчивый день (Sharpe 0.44, MaxDD −27.8%, skew −1.09); худший день портфеля −21.9% (2025-10-10, Пт).
...
- Отрицательная асимметрия и CVaR 1% = −14.9% указывают на хвостовые риски.
...
- Равный **peak-вес 1/N** на пару (N = 49 конс. / 33 опт.), без реинвестирования, NAV=100
...
| ----------------------------- | --------------------- | --------------------- | --------------------- | --------------------- | --------------------- | --------------------- | ------------------ | ---------------- |
| Total Return                  | +33.6%                | −9.8%                 | +18.0%                | +35.3%                | −7.5%                 | +19.9%                | −32.2%             | **+28.3%**       |
| CAGR (compounded)             | +14.4%                | −4.7%                 | +8.0%                 | +15.1%                | −3.6%                 | +8.8%                 | −16.5%             | **+12.3%**       |
| Sharpe (0% rf)                | +0.43                 | −0.13                 | +0.23                 | +0.46                 | −0.10                 | +0.26                 | −0.21              | **+0.28**        |
| Sharpe / √exposure            | +0.47                 | −0.14                 | +0.25                 | +0.51                 | −0.11                 | +0.29                 | −0.21              | **+0.28**        |
...
| Longest underwater            | 199 дн.               | 559 дн.               | **222 дн.**           | 199 дн.               | 301 дн.               | 248 дн.               | 535 дн.            | 233 дн.          |
| Calmar                        | +0.64                 | −0.13                 | +0.32                 | +0.71                 | −0.11                 | +0.37                 | −0.21              | **+0.35**        |
| Profit Factor                 | 1.10                  | 0.97                  | **1.05**              | 1.11                  | 0.98                  | **1.06**              | 0.97               | 1.04             |
| Win Rate (trades)             | 48.0%                 | 45.1%                 | 46.5%                 | 47.8%                 | 45.6%                 | 46.8%                 | **51.0%**          | 50.2%            |
| Median trade return           | −0.003%               | −0.013%               | −0.008%               | −0.005%               | −0.019%               | −0.007%               | **+0.078%**        | +0.007%          |
| Information Ratio (vs B&H 49) | —                     | 0.19 (taker)          | 0.42 (maker)          | —                     | 0.21 (taker)          | **0.44 (maker)**      | —                  | —                |
| Exposure                      | 82.3%                 | 82.3%                 | 82.3%                 | 78.7%                 | 78.7%                 | 78.7%                 | 100%               | 100%             |
...
**Итог и рекомендация.**  
Сигнал b6 → long статистически подтверждён и даёт gross-альфу, но **только с maker-исполнением** — taker убыточен из-за высокой частоты сделок. Отбор пар по train желателен, но не обязателен. Sharpe 0.23–0.26 указывает, что стратегия — скорее **дополнение** к портфелю, чем его основа. Рекомендуется использовать в комбинации с другими сигналами.
