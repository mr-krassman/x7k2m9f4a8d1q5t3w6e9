...
Консервативный сценарий — equity curve
...
Оптимистичный сценарий — equity curve
...
Корреляция по дням — оптимистичный
...
Распределение доходностей — оптимистичный
